                        ...
                        <div class="block">
                            <div class="head dblue">
                                ...
                                <div class="data-fluid">
                                    <form action="../../back_addbus" method="post">
                                    <table class="table fpTable lcnp" cellpadding="0" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <%--取商铺号--%>
                                                <td><input name="gid" type="text" width="20"/> </td>

                                                <%--如果一个订单，有多个人买票，取出数据样式排版还未解决--%>
                                                <td>
                                                    <input name="gname" type="text" width="20"/>
                                                </td>

                                                <td>

                                                    <input name="gprice" type="text" width="20"/>
                                               </td>

                                                <td><input name="gphone" type="text" width="20"/></td>
                                                ...
                                                <%--取出订单时间--%>
                                                <td>
                                                    <input name="sdiscount" type="text" width="20"/>
                                               </td>
                                                <%--&lt;%&ndash;订单操作&ndash;%&gt;--%>
                                                <td>
